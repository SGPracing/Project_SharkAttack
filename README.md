...
## Methods ##
Targetted data cleaning and analysis was performed under *Python* and *Pandas*, and saved in new dataset to be manipulated. The entire process was carefully worked in order to allow statistical analysis as accurate as possible. The varialbes were analysed independently of each other, with the exception of the variables of fatality and activity.
